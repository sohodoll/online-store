...
import { removeItemFromCart, updateHeader } from '../../../app';
...
function createReceipt(array: ItemCart[]): HTMLDivElement {
    ...
    appendChildElements(receipt, [receiptTitle, promoPanel, receiptItemsPrice, receiptDelivery, hr, receiptTotalPrice, receiptPriceWithPromo, receiptBuyNow]);
    return receipt;
}
